...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF008000);
  late Color secondary = const Color(0xFF07621A);
  late Color tertiary = const Color(0xFF57CC99);
  late Color alternate = const Color(0xFF80ED99);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF004E64);
  late Color accent2 = const Color(0xFF00A5CF);
  late Color accent3 = const Color(0xFF25A18E);
  late Color accent4 = const Color(0xFF9FFFCB);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF14ED30);
